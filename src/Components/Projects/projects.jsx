...
const projects = allProjects.map((item) => {
    ...
    return (
      <div className="project-item text-blue-500 bg-white shadow-md duration-500  transition-transform duration-300 ease-in-out hover:scale-105 rounded-lg p-6 mb-6" key={item.id}>
        <h2 className="text-2xl text-blue-500 font-bold mb-2">{item.title}</h2>
  ...
  return (
    <section className="projects-container  py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl text-blue-500 font-bold text-center mb-12">MY PROJECTS</h1>
